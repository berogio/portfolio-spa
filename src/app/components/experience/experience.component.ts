  ...
  experiences: WorkExperience[] = [
    {
      ...
      year: '2023',
      description:
        'As a Fullstack Developer at OZG, my focus was on crafting user-friendly web applications. With proficient knowledge in HTML, CSS, SCSS, Bootstrap, Angular, Angular Material, and Node.js, I designed responsive user interfaces and developed dynamic, interactive single-page applications. My specific contribution involved the development of forms, enabling efficient data collection and processing. Applying agile methodologies and integrating databases, I contributed to the continuous improvement of the application landscape.',
    },
    {
      logo: '/assets/images/upwork.png',
